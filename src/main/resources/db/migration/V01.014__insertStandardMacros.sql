...
VALUES (    'macro-payment-by-staff',
    ...
    {staff_account}  {default_currency} -{amount}',
...
VALUES (    'macro-payment-for-goods',
    ...
    '{date} * {partner} | {description}
    ; invoice:{invoice_number}
    {inventory_account}      {default_currency} {amount}
    {liability_account}      {default_currency} -{amount}',
    '{"balanceCheck":true,"minPostings":2}',
...
VALUES (    'macro-invoice-for-services',
    ...
    '{date} * {partner} | {description}
    ; invoice:{invoice_number}
    {revenue_account}      {default_currency} -{amount}
    {receivable_account}   {default_currency} {amount}',
    '{"balanceCheck":true,"minPostings":2}',
...
VALUES (    'macro-customer-pays-invoice',
    ...
    '{date} * {partner} | {description}
    ; invoice:{invoice_number}
    {ingoing_account}      {default_currency} {amount}
    {receivable_account}   {default_currency} -{amount}',
    '{"balanceCheck":true,"minPostings":2}',
...
VALUES (    'macro-inventory-adjustment',
    ...
    {expense_account}        {default_currency} {adjustment_amount}
    {inventory_account}      {default_currency} -{adjustment_amount}',
    '{"balanceCheck":true,"minPostings":2}',
...
VALUES (    'macro-record-depreciation',
    ...
    {depreciation_expense_account}    {default_currency} {depreciation_amount}
    {asset_account}                   {default_currency} -{depreciation_amount}',
    '{"balanceCheck":true,"minPostings":2}',
...
VALUES (    'macro-tax-provision',
    ...
    '[{"name":"date","type":"date","prompt":"Transaction date (typically December 31)","defaultValue":"{year}-12-31","required":true},{"name":"description","type":"text","prompt":"Description of tax provision","defaultValue":"Tax provision for {year}","required":true},{"name":"additional_tax_amount","type":"amount","prompt":"Additional tax to provision (total estimated tax for the year, minus tax already expensed to 8900 this year)","required":true}]',
    '{date} | {description}
    ; YearEnd:TaxProvision
    8:8900    {default_currency} {additional_tax_amount}
    2:20:220:2208    {default_currency} -{additional_tax_amount}',
    '{"balanceCheck":true,"minPostings":2}',
    'Record year-end tax provision for income and capital taxes. The amount is NOT your total tax for the year - it is the difference between your total estimated tax and whatever has already been recognised as expense (account 8900) from acomptes billed or paid earlier in the same year. This creates a liability (2208) for the remaining tax owed but not yet paid. See the Help section ("Tax provisions and payments across years") for detailed instructions and worked examples.',
    NOW(),
    NOW());
...
VALUES (    'macro-tax-payment',
    ...
    '{date} * {partner} | {description}
    ; TaxPayment:
    2:20:220:2208    {default_currency} {provision_amount}
    8:8900    {default_currency} {actual_amount - provision_amount}
    {bank_account}    {default_currency} -{actual_amount}',
    '{"balanceCheck":true,"minPostings":2}',
    'This macro handles three scenarios: 1. If actual = provision: Only liability and bank accounts are affected. 2. If actual > provision: Additional tax expense is recorded. 3. If actual < provision: Tax expense is reduced (negative amount). Example: Provision was CHF 350, actual bill is CHF 380 - Debit 220 (Tax liability): CHF 350 (clears the provision), Debit 8900 (Tax expense): CHF 30 (additional expense), Credit 1020 (Bank): CHF 380 (total payment). See the Help section ("Tax provisions and payments across years") for detailed instructions and worked examples.',
    NOW(),
    NOW());
...
VALUES (    'macro-legal-reserve-allocation',
    ...
    2:290:2979    {default_currency} {allocation_amount}
    2:290:2950    {default_currency} -{allocation_amount}',
    '{"balanceCheck":true,"minPostings":2}',
