...
> **NOTE:** This test case has been moved to [Test Case 007: Year-End Closing](./007-year-end-closing.md).
> The LegalReserveAllocation macro is a year-end closing entry, not a regular
> macro transaction. It is now tested as part of test 007 (year-end closing flow)
> along with the TaxProvision macro. This document is kept for historical reference.
